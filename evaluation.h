...
struct Evaluation : Noncopyable
{
	...
	int mg_piece_value[6] = { 40, 233, 257, 307, 634, 0, };
	int eg_piece_value[6] = { 68, 263, 273, 475, 904, 0, };
	
	int mg_pawn_psqt[64] = {
		0, 0, 0, 0, 0, 0, 0, 0,
		0, 9, 3, 52, 39, 28, -28, -45,
		4, 2, 22, 35, 36, 54, 21, -18,
		-12, -7, 1, 2, 17, 16, -8, -9,
	...
	int mg_knight_psqt[64] = {
		-67, -22, -29, -11, -5, -18, -15, -32,
		-33, -21, -20, -7, -9, 16, -15, -5,
		-18, -12, -5, -5, 15, 38, 4, 5,
		-13, 2, 10, 34, 24, 34, 9, 21,
		4, 6, 13, 21, 23, 23, 27, 15,
		-11, -3, 0, 0, 13, 3, 17, 5,
		-14, -11, -7, 8, 6, 6, 11, 10,
		-36, -4, -22, -11, -3, 3, -2, -12,
	};
	int mg_bishop_psqt[64] = {
		-14, -25, -20, -39, -34, -37, -12, -29,
		-18, -23, -14, -24, -24, -21, -35, -24,
		-6, 8, 0, 4, -3, 29, 10, 2,
		-14, -3, -2, 7, 4, 4, -2, -17,
		-4, -16, -3, 7, 5, 3, -5, 9,
		-2, 10, 6, 7, 10, 9, 14, 18,
		20, 12, 19, 2, 9, 18, 33, 24,
		11, 23, 10, -2, 10, 3, 18, 35,
	};
	int mg_rook_psqt[64] = {
		2, -9, -12, -13, -1, 4, 5, 13,
		-23, -26, -20, -4, -14, 12, 12, 22,
		-31, -2, -11, -5, 26, 24, 53, 21,
		-25, -11, -11, -7, 0, 9, 15, 6,
	...
	int mg_queen_psqt[64] = {
		-25, -23, -10, 4, -5, -6, 12, -5,
		-5, -28, -34, -44, -47, -6, -5, 39,
		-1, -10, -17, -11, -4, 15, 30, 34,
		-13, -11, -19, -30, -24, -7, 1, 10,
	...
	int mg_king_psqt[64] = {
		...
		-7, 11, 1, -4, 9, 24, 18, 10,
		3, -2, -13, -25, -26, -5, -5, -16,
		-8, -8, -14, -46, -43, -12, -29, -51,
		-6, 21, -6, -15, -7, -18, -5, -31,
		33, -10, -4, -1, -6, -16, -5, 16,
		51, 34, 43, -4, 56, -9, 27, 68,
	};
	int eg_pawn_psqt[64] = {
		0, 0, 0, 0, 0, 0, 0, 0,
		9, 8, 26, 12, 18, 14, 28, 24,
		18, 24, 9, -2, 3, 9, 27, 22,
		13, 7, 0, -8, -7, -2, 6, 4,
		4, 1, -5, -9, -9, -5, -3, -3,
		-1, -4, -6, -5, -5, -4, -8, -5,
	...
	int eg_king_psqt[64] = {
		...
		-2, 16, 20, 25, 31, 31, 27, 6,
		-9, 6, 17, 21, 23, 23, 16, 0,
		-18, -4, 6, 14, 12, 7, 2, -8,
		-22, -10, -3, 1, 0, -2, -5, -12,
		-22, -8, -8, -7, -6, -5, -8, -16,
		-41, -19, -14, -10, -22, -8, -17, -44,
	};
	
	int mg_king_ring_attack_potency[6] = { 0, 55, 86, 65, 35, 0, };
	...
	int mg_bishop_mobility[14] = { -46, -54, -29, -23, -11, -5, 0, 5, 8, 11, 12, 25, 25, 27, };
	int eg_bishop_mobility[14] = { -64, -49, -18, -6, -1, 2, 7, 10, 13, 15, 16, 13, 13, 10, };
	
	int mg_rook_mobility[15] = { -2, -31, -33, -26, -21, -19, -17, -22, -17, -13, -8, -8, -7, 0, 5, };
	int eg_rook_mobility[15] = { -5, -49, -22, -15, -12, -3, 0, 3, 4, 7, 9, 12, 15, 15, 15, };
	
	int mg_queen_mobility[28] = { 0, 0, -2, -25, -56, -30, -25, -24, -23, -24, -21, -18, -16, -13, -12, -12, -11, -14, -11, -8, 0, 10, 24, 19, 10, 14, -2, -3, };
	int eg_queen_mobility[28] = { 0, 0, -1, -23, -36, -32, -22, -12, -4, 7, 7, 10, 13, 13, 14, 16, 15, 18, 17, 14, 11, 2, -3, -2, -2, 0, -9, -6, };
	
	int mg_king_mobility[9] = { 0, -7, -34, -24, -11, 18, -3, 17, 43, };
	...
	int mg_passed_pawn_blocked[8] = { 0, 17, 18, -18, -48, -25, -4, 0, };
	int eg_passed_pawn_blocked[8] = { 0, 39, 20, 17, 13, 15, 8, 0, };
